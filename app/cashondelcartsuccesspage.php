...
<head>
    ...
    <script>
        function calculateSubTotal() {
            var totalItems = parseFloat(document.getElementById("totalgana").innerText);
            var deliveryFee = parseFloat(document.getElementById("delfee").innerText);
            var subTotal = totalItems + deliveryFee;
        ...
        <div class="row col-12 text-center">
            ...
            <div class="row col-12 text-start">
                ...
                <div class="col-4">
                    ...
                    <br>
                    <h5><b><i>Delivery Fee:-</i>Rs. <span id="delfee"><?php echo $delfee ?></span>.00</b></h5>
                    <br>
