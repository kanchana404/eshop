...
<body class="p-3 m-0 border-0 bd-example m-0 border-0 bd-example-row bd-example-row-flex-cols">
  ...
  <div class="row col-12">
    ...
    <div class="col-lg-6 col-md-12 col-12" style="font-family: 'Dancing Script', cursive; font-family: 'Shantell Sans', cursive;">
      <br><br><br><br>
      <hr>
      ...
      <div class="col-12 row">
        ...
        <div class="col-4"></div>
        <div class="col-4">
          <a href="#" class="text-primary-emphasis" onclick="forgotPassword();"><b>Forgot Password?</b></a>
        </div>
      </div>
      <br>
      <div class="row col-12">
      ...
      <div class="col-12 text-start">
        <div class="col-10">
          <b>New to our store? Please <a href="../components/Signup.php">Create a New Account</a>.</b>
        </div>
      </div>
    </div>
  </div>
  <br><br>
  <div class="col-12 text-center">© 2023 AMELIYA || All Rights Reserved</div>

  <script src="../app/script.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <script src="../app/forgot-password.js"></script>
</body>
</html>
